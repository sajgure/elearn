                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $obj_marks = $this->session->userdata('obj_marks'); echo round($obj_marks); ?>
                                        </td>
                                        <td>
                                            <span class="label label-sm <?php if($obj_marks<10){ echo 'label-warning'; $flag=1;}else{ echo 'label-success';} ?> ">
                                            <b><?php if($obj_marks<10){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';} ?></b> </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            if($type=="statement") 
            {
                ...
                { 
                    if($course_id == '1' || $course_id == '2' || $course_id == '3')
                    {
                        ...
                        if($d_cnt<0){ $d_cnt=0; } $total_marks=$d_cnt+$h1+$h2+$a+$b+$w; if($total_marks>15) { $total_marks=15; } 
                    }
                    if($course_id == '4' || $course_id == '5' || $course_id == '6')
                    {
                        $d_cnt=7.5; $q=2; $h1=$h1_2=$h2=$a=$b=$w=1; 
                        ...
                        if($d_cnt<0){ $d_cnt=0; } $total_marks=$d_cnt+$q+$h1+$h1_2+$h2+$a+$b+$w; if($total_marks>15) { $total_marks=15; } 
                    }
                } 
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="label label-sm <?php if($total_marks < 7){ echo 'label-warning'; $flag=1;}else{ echo 'label-success';} ?> ">
                                                <b><?php if($total_marks < 8){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';} ?></b> </span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="label label-sm <?php if($speed_marks<16){ echo 'label-warning'; $flag=1;}else{ echo 'label-success';} ?> ">
                                            <b><?php if($speed_marks<16){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';} ?></b> </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="label label-sm <?php if($mobile_marks<2){ echo 'label-warning'; $flag=1;}else{ echo 'label-success';} ?> ">
                                            <b><?php if($mobile_marks<2){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';} ?></b></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
