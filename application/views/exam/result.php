					...
					<div class="widget-content">
						<table width="100%" style=" width:100%; border-color: #000;" border="1">
							...
							<tr>
								...
								<td style="text-align:center; color: #000;">25</td>
								<td style="text-align:center; color: #000;"><?php $obj_marks = $this->session->userdata('obj_marks'); echo round($obj_marks); ?></td>
								<td style="text-align:center; color: #000;"><?php if($obj_marks<10){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';} ?></td>
							</tr>
							...
							<tr>
								...
								<td style="text-align:center; color: #000; text-align: center; vertical-align: middle; margin-top: 5px;" ><?php if($email_marks < 2){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';} ?></td>
							</tr>
							<?php } ?>
							<tr>
